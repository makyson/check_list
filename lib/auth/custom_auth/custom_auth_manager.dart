...
class CustomAuthManager {
  ...
  Future signOut(BuildContext context) async {
    ...
    grazeAuthUserSubject.add(
      GrazeAuthUser(loggedIn: false),
    );
    persistAuthData();
  ...
  GrazeAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = GrazeAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    grazeAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
