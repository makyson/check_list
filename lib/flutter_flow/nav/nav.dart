...
import '/index.dart';
import '../../pages/home/home/dere.dart';
import '../../pages/service/abrirsevico.dart';
import '../../pages/serviceoperador/abrirsevicooperador.dart';
...
class AppStateNotifier extends ChangeNotifier {
  ...
  void update(GrazeAuthUser newUser) {
    final shouldUpdate =
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/Newoperador',
          requireAuth: true,
          builder: (context, params) => DetalyOperadorWidget(),
        ),
        FFRoute(
          name: 'd',
          path: '/d',
          builder: (context, params) => const DraftsScreen(),
        ),
        FFRoute(
          name: 'ListarDefeitos',
          path: '/ListarDefeitos',
          //  ListarDefeitosWidget()
          builder: (context, params) => ListarDefeitosWidget(
              maquinaid: params.getParam('id', ParamType.String)),
        ),
        FFRoute(
          name: 'ListarDetalyOperador',
          path: '/ListarDetalyOperador',
          //  ListarDefeitosWidget()
          builder: (context, params) => ListarDefeitosOperadorWidget(
              maquinaid: params.getParam('id', ParamType.String)),
        ),
        FFRoute(
...
extension NavigationExtensions on BuildContext {
  ...
  void safePopAndRebuildBelow() {
    if (ModalRoute.of(this)?.canPop ?? false) {
      Navigator.of(this).popUntil((route) => route.isFirst);
      // Coloque aqui o código para reconstruir o componente abaixo da pilha
    }
  }
}
...
class FFRoute {
  ...
  final List<String> requirepermissions;
  final Map<String, Future<dynamic> Function(String)> asyncParams;
  ...
  GoRoute toRoute(AppStateNotifier appStateNotifier) => GoRoute(
        ...
        redirect: (context, state) {
          ...
          if (requirepermissions.isNotEmpty) {
            ...
            if (!requirepermissions.any(userPermissions.contains)) {
              return '/login'; // Redirect to login if user doesn't have required permissions
            }
          }
